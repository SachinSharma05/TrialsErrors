...
Public Class frmRequiredStock

    Private Sub frmRequiredStock_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        MainMenu.Panel1.Visible = True
    End Sub

    Private Sub frmRequiredStock_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadCombo()
        ...
        Next
        Me.TextBox2.Text = stock

        Dim Limit As Integer
        For Each row As DataGridViewRow In Me.DataGridView1.Rows
            Limit += row.Cells(5).Value
        Next
        Me.TextBox3.Text = Limit

        Dim Required As Integer
        For Each row As DataGridViewRow In Me.DataGridView1.Rows
            Required += row.Cells(6).Value
        Next
        Me.TextBox4.Text = Required
    End Sub
    ...
    Private Sub RefreshData()
        ...
        Dim str As String = "select Prod_Type, Cat_Type, SubCat_Type, Prod_Name, Stock, Limit, Limit-Stock As Stock_Required from ItemMaster"
    ...
    Private Sub frmRequiredStock_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        Try
            ...
            myConnection.ConnectionString = connString
            myConnection.Open()
            sqlsearch = "SELECT Prod_Type, Cat_Type, SubCat_Type, Prod_Name, Stock, Limit, Limit-Stock As Stock_Required FROM Itemmaster WHERE Prod_Type ='" & ComboBox1.Text & "'"
    ...
    Private Sub ComboBox2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox2.SelectedIndexChanged
        Try
            ...
            myConnection.ConnectionString = connString
            myConnection.Open()
            sqlsearch = "SELECT Prod_Type, Cat_Type, SubCat_Type, Prod_Name, Stock, Limit, Limit-Stock As Stock_Required FROM Itemmaster WHERE Prod_Type='" & ComboBox1.Text & "' And " & "Cat_Type='" & ComboBox2.Text & "'"
            Dim adapter As New OleDbDataAdapter(sqlsearch, myConnection)
            Dim dt As New DataTable("Items")
            adapter.Fill(dt)
            DataGridView1.DataSource = dt
    ...
    Private Sub ComboBox3_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox3.SelectedIndexChanged
        ...
        myConnection.ConnectionString = connString
        myConnection.Open()
        sqlsearch = "SELECT Prod_Type, Cat_Type, SubCat_Type, Prod_Name, Stock, Limit, Limit-Stock As Stock_Required FROM Itemmaster WHERE Prod_Type='" & ComboBox1.Text & "' And Cat_Type='" & ComboBox2.Text & "' And " & "SubCat_Type='" & ComboBox3.Text & "'"
        Dim adapter As New OleDbDataAdapter(sqlsearch, myConnection)
        Dim dt As New DataTable("Items")
        adapter.Fill(dt)
        DataGridView1.DataSource = dt
    ...
    Private Sub ComboBox4_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox4.SelectedIndexChanged
        ...
        myConnection.ConnectionString = connString
        myConnection.Open()
        sqlsearch = "SELECT Prod_Type, Cat_Type, SubCat_Type, Prod_Name, Stock, Limit, Limit-Stock As Stock_Required FROM Itemmaster WHERE Prod_Name ='" & ComboBox4.Text & "'"
        Dim adapter As New OleDbDataAdapter(sqlsearch, myConnection)
        Dim dt As New DataTable("Items")
        adapter.Fill(dt)
        DataGridView1.DataSource = dt
    ...
    Private Sub DataGridView1_RowPostPaint(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowPostPaintEventArgs) Handles DataGridView1.RowPostPaint
        ...
        For i As Integer = 0 To dgv.Rows.Count - 1
            For ColNo As Integer = 0 To 6
                If Val(dgv.Rows(i).Cells(5).Value.ToString) > Val(dgv.Rows(i).Cells(4).Value.ToString) Then
                    dgv.Rows(i).Cells(6).Style.BackColor = Color.Red
                    dgv.Rows(i).Cells(6).Style.ForeColor = Color.White
                Else
    ...
    Private Sub TextBox1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox1.TextChanged
        ...
        myConnection.ConnectionString = connString
        myConnection.Open()
        sqlsearch = "SELECT Prod_Type, Cat_Type, SubCat_Type, Prod_Name, Stock, Limit, Limit-Stock As Stock_Required FROM Itemmaster WHERE Prod_Name LIKE'%" &
        TextBox1.Text & "%'"
        Dim adapter As New OleDbDataAdapter(sqlsearch, myConnection)
